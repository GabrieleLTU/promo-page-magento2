<?php
namespace Visma\PromoPage\Observer;
...
class afterConfigChange implements ObserverInterface
{
    ...
    {
        $isModuleEnable = $this->_scopeConfig->getValue('promopage/general/enable', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        $outputPath = "advanced/modules_disable_output/Visma_PromoPage";
